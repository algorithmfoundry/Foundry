/*
 * File:                AbstractBatchAndOnlineLearner.java
 ...
 * @since   3.0
 */
public abstract class AbstractBatchAndOnlineLearner<DataType, ResultType>
    extends AbstractCloneableSerializable
    implements BatchLearner<Iterable<? extends DataType>, ResultType>,
        OnlineLearner<DataType, ResultType>
{

    /** 
     * Creates a new instance of {@code AbstractBatchAndOnlineLearner}.
     */
    public AbstractBatchAndOnlineLearner()
    {
        super();
    }

    @Override
    public AbstractBatchAndOnlineLearner<DataType,ResultType> clone()
    {
        @SuppressWarnings("unchecked")
        AbstractBatchAndOnlineLearner<DataType,ResultType> clone =
            (AbstractBatchAndOnlineLearner<DataType,ResultType>) super.clone();
        return clone;
    }

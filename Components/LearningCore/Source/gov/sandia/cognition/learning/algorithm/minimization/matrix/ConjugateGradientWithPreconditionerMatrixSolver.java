...
public class ConjugateGradientWithPreconditionerMatrixSolver
    extends IterativeMatrixSolver<MatrixVectorMultiplierWithPreconditioner>
{

    /**
     * The matrix vector multiplier
     */
    private MatrixVectorMultiplierWithPreconditioner A;
     ...
     */
    private ConjugateGradientWithPreconditionerMatrixSolver()
    {
        super(null, null);
     ...
     */
    public ConjugateGradientWithPreconditionerMatrixSolver(Vector x0,
        Vector rhs)
    {
        super(x0, rhs);
        A = null;
     ...
     */
    private ConjugateGradientWithPreconditionerMatrixSolver(
        ConjugateGradientWithPreconditionerMatrixSolver copy)
    {
        super(copy);
        this.A = copy.A;
    ...
    {
        if (!(o instanceof ConjugateGradientWithPreconditionerMatrixSolver))
        {
            return false;
        }
        ConjugateGradientWithPreconditionerMatrixSolver other =
            (ConjugateGradientWithPreconditionerMatrixSolver) o;

/*
 * File:                ClusterMeanLinkDivergenceFunctionTest.java
 ...
 * @since  2.0
 */
public class ClusterMeanLinkDivergenceFunctionTest
    extends TestCase
{
    public ClusterMeanLinkDivergenceFunctionTest(
        String testName)
    {
        super(testName);
    }
    ...
    {
        ClusterMeanLinkDivergenceFunction<DefaultCluster<Vector>, Vector>
            instance = new ClusterMeanLinkDivergenceFunction<DefaultCluster<Vector>, Vector>();
    ...
    /**
     * Test of evaluate method, of class gov.sandia.cognition.learning.clustering.divergence.ClusterMeanLinkDivergenceFunction.
     */
    public void testEvaluate()
    {
        ...
        double expected = 0.0;
        int count = 0;
        for ( Vector v1 : c1.getMembers() )
        {
            for ( Vector v2 : c2.getMembers() )
            {
                expected += v1.euclideanDistance(v2);
                count++;
            }
        }
        
        expected /= (double) count;

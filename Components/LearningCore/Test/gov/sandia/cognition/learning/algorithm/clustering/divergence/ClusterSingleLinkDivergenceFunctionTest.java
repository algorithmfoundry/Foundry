/*
 * File:                ClusterSingleLinkDivergenceFunctionTest.java
 ...
 * @since  2.0
 */
public class ClusterSingleLinkDivergenceFunctionTest
    extends TestCase
{
    public ClusterSingleLinkDivergenceFunctionTest(
        String testName)
    {
        super(testName);
    }
    ...
    {
        ClusterSingleLinkDivergenceFunction<DefaultCluster<Vector>, Vector>
            instance = new ClusterSingleLinkDivergenceFunction<DefaultCluster<Vector>, Vector>();
    ...
    /**
     * Test of evaluate method, of class gov.sandia.cognition.learning.clustering.divergence.ClusterSingleLinkDivergenceFunction.
     */
    public void testEvaluate()
    {
        ...
        c1.getMembers().add(new Vector2(-1.109200, 3.111700)); // Closest
        c1.getMembers().add(new Vector2(-1.566900, 1.835100));
        c1.getMembers().add(new Vector2(-2.658500, 0.664900));
        c1.getMembers().add(new Vector2(-4.031700, 2.845700)); 
        ...
        c2.getMembers().add(new Vector2(4.031700, 1.622300)); 
        ...
        c2.getMembers().add(new Vector2(0.193700, 3.643600)); // Closest
        ...
        double expected = c1.getMembers().get(1).euclideanDistance(c2.getMembers().get(6));

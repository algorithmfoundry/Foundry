/*
 * File:                ConfidenceWeightedDiagonalDeviationTest.java
...
/**
 * Unit tests for class ConfidenceWeightedDiagonalDeviation.
 *
 * @author  Justin Basilico
 * @since   3.3.0
 */
public class ConfidenceWeightedDiagonalDeviationTest
{
     ...
     * Creates a new test.
     */
    public ConfidenceWeightedDiagonalDeviationTest()
    {
    }

    /**
     * Test of constructors of class ConfidenceWeightedDiagonalDeviation.
     */
    @Test
    public void testConstructors()
    {

        double confidence = ConfidenceWeightedDiagonalDeviation.DEFAULT_CONFIDENCE;
        double defaultVariance = ConfidenceWeightedDiagonalDeviation.DEFAULT_DEFAULT_VARIANCE;
        ConfidenceWeightedDiagonalDeviation instance = new ConfidenceWeightedDiagonalDeviation();
        ...
        instance = new ConfidenceWeightedDiagonalDeviation(confidence, defaultVariance);
        assertEquals(confidence, instance.getConfidence(), 0.0);
        assertEquals(defaultVariance, instance.getDefaultVariance(), 0.0);
    }

    /**
     * Test of createInitialLearnedObject method, of class ConfidenceWeightedDiagonalDeviation.
     */
    @Test
    ...
    /**
     * Test of update method, of class ConfidenceWeightedDiagonalDeviation.
     */
    @Test
...
//            assertEquals(output, result.evaluate(input));
    ...
    /**
     * Test of getConfidence method, of class ConfidenceWeightedDiagonalDeviation.
     */
    @Test
    ...
    /**
     * Test of setConfidence method, of class ConfidenceWeightedDiagonalDeviation.
     */
    @Test
    public void testSetConfidence()
    {
        ...
        double[] goodValues = { 0.5, 0.9, 0.95, 0.99, 0.999, 1.0, 0.993 };
        ...
        double[] badValues = { 0.0, 0.25, 1.1, -0.1, -1.0, -1.1, -random.nextDouble() };
    ...
    /**
     * Test of getDefaultVariance method, of class ConfidenceWeightedDiagonalDeviation.
     */
    @Test
    ...
    /**
     * Test of setDefaultVariance method, of class ConfidenceWeightedDiagonalDeviation.
     */
    @Test

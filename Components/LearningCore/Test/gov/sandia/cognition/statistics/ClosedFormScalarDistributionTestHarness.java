/*
 * File:                ClosedFormScalarDistributionTestHarness.java
...
/**
 * Unit tests for ClosedFormScalarDistribution.
 *
 * @param <NumberType> Number type
 * @author krdixon
 */
public abstract class ClosedFormScalarDistributionTestHarness<NumberType extends Number>
    extends ScalarDistributionTestHarness<NumberType>
{
     ...
     */
    public ClosedFormScalarDistributionTestHarness(
        String testName)
    {
        super(testName);
    }

    public abstract ClosedFormScalarDistribution<NumberType> createInstance();
    ...
    public void testDistributionConvertToVector()
    {
        ...
        ClosedFormScalarDistribution<NumberType> instance = this.createInstance();

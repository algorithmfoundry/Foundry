/*
 * File:                SmoothScalarDistributionTestHarness.java
...
/**
 * Unit tests for SmoothScalarDistribution.
 *
 * @author krdixon
 */
public abstract class SmoothScalarDistributionTestHarness
    extends ClosedFormScalarDistributionTestHarness<Double>
{
     ...
     */
    public SmoothScalarDistributionTestHarness(
        String testName)
    {
        super(testName);
    }

    public abstract SmoothScalarDistribution createInstance();
    ...
    /**
     * Test of getProbabilityFunction method, of class SmoothScalarDistribution.
     */
    public void testDistributionGetDistributionFunction()
    {
        System.out.println("Distribution.getDistributionFunction");
        SmoothScalarDistribution instance = this.createInstance();
        ScalarProbabilityDensityFunction pdf = instance.getProbabilityFunction();
        assertNotNull( pdf );
    ...
    public void testPDFGetDistributionFunction()
    {
        ...
        SmoothScalarDistribution instance = this.createInstance();
        ScalarProbabilityDensityFunction pdf = instance.getProbabilityFunction();
        ScalarProbabilityDensityFunction pdf2 = pdf.getProbabilityFunction();
        assertNotNull( pdf2 );
        assertNotSame( instance, pdf );
        assertSame( pdf, pdf2 );
    }
    ...
    public void testCDFDifferentiate()
    {
        ...
        SmoothCumulativeDistributionFunction cdf = instance.getCDF();
        ScalarProbabilityDensityFunction pdf = instance.getProbabilityFunction();
        ScalarProbabilityDensityFunction dfdx = cdf.getDerivative();

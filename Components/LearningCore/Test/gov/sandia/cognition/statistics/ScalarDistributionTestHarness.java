/*
 * File:                ScalarDistributionTestHarness.java
...
/**
 * Unit tests for ScalarDistribution.
 *
 * @param <NumberType> Number type
 * @author krdixon
 */
public abstract class ScalarDistributionTestHarness<NumberType extends Number>
    extends TestCase
{
     ...
     */
    public ScalarDistributionTestHarness(
        String testName)
    {
        super(testName);
    }
     ...
     * New Distribution
     */
    public abstract ScalarDistribution<NumberType> createInstance();
    ...
    public void testCreateInstance()
    {
        ...
        ScalarDistribution<? extends Number> instance = this.createInstance();
    ...
    public void testCDFClone()
    {
        ...
        ScalarDistribution<? extends Number> distribution = this.createInstance();
...
//        assertNotSame( r13, r14 );
    ...
    /**
     * Test of getCDF method, of class ScalarDistribution.
     */
    ...
    /**
     * Test of getVariance method, of class ScalarDistribution.
     */
